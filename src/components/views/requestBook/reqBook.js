...
class ReqBook extends React.Component {
    constructor(props) {
        super(props);
        this.state = {
            name: '',
    ...
    validateField(field, value) {
        if (value.length <= 0) {
            return <div className="alert alert-danger"><span className="text-capitalize">{field}</span> is required
                field.</div>;
        } else {
            if (field == 'email') {
    ...
    handleSubmit(event) {
        swal("Good job!", "Thank you for Requesting", "success");
                ...
                <div className="card box_shw2 border-0 px-3 rounded-2 mb-3 w_500 py-4 mx-auto mt-5">
                    ...
                    <div className="card-body">
                        ...
                        <form onSubmit={this.handleSubmit} encType="multipart/form-data" autoComplete="off">
                            ...
                            <div className="position-relative form-group">
                                <input name="company" type="text" className="text-field form-control mb-3 bg_grey border-0 py-1" placeholder="Designation" value={this.state.company} onChange={this.handleChange} onBlur={this.handleBlur} required="required" />
                            </div>
                            <div className="position-relative form-group">
